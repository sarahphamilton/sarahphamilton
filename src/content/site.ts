export const site = {
  ...
  intro:
    "I find operational friction, build the system, align the people, and measurably improve execution.",
};
...
export const capabilityLanes = [
  { title: "Program & Implementation", skills: ["Program and project execution", "Implementation planning", "Onboarding", "Stakeholder coordination"] },
  { title: "Operations & Process Improvement", skills: ["Workflow design", "SOP development", "Operating rhythms", "Data-informed decisions"] },
  { title: "Enablement & Adoption", skills: ["Training and facilitation", "Change management", "Documentation", "Sustained adoption"] },
];
...
export const credentials = [
  ...
  { name: "SQL Basic Certificate", detail: "HackerRank · Completed" },
  { name: "PMP Certification", detail: "Target Sept 2026" },
  {
